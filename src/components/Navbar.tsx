  ...
  return (
    <header className="sticky top-0 z-40 bg-[#064e3b]/95 backdrop-blur-xl border-b border-[#065f46] px-4 lg:px-8 py-3.5 shadow-2xl transition-all">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-bold font-heading tracking-tight text-[#fbbf24] flex items-center gap-1.5">
                مَنَصَّةُ عُمْرَان
        ...
        <div className="hidden md:flex items-center gap-6 px-4 py-1.5 rounded-2xl bg-[#022c22]/70 border border-[#065f46] text-xs text-[#f0f9f6]">
            ...
            <div className="flex items-center gap-2.5 bg-[#022c22]/80 border border-[#065f46] rounded-2xl px-3.5 py-1.5 shadow-inner">
              ...
              <div className="text-right">
                ...
                <div className="text-[10px] text-[#86efac]">
                  {currentUser.role === 'admin' ? 'المشرف العام (المعلم)' : 'حساب طالب'}
                </div>
              </div>
